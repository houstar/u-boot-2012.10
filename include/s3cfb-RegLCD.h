...
#else //if defined(CONFIG_CPU_S3C6400) || defined(CONFIG_CPU_S3C6410) || defined(CONFIG_CPU_S5P6440) || defined(CONFIG_CPU_S5PC100)
...
#define S3C_HOSTIFBREG(x)				__REG((x) + S3C64XX_HOSTIFB_ADDR)

/*LCD 特殊寄存器*/
#define MIFPCON_REG                    __REG(0x7410800C)  
  #define  SEL_BYPASS_MASK             0x00000008             // 为 LCD 旁路选择控制模式
#define SPCON_REG                      __REG(ELFIN_GPIO_BASE + SPCON_OFFSET) 
  #define LCD_SEL_MASK                 0x00000003             //LCD管脚输出格式
  #define RGB_IF_STYLE_MASK            0x00000001             //RGB格式  
